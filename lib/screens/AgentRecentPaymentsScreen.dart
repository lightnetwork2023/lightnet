...
class AgentRecentPaymentsScreen extends StatefulWidget {
  final String location;

  const AgentRecentPaymentsScreen({
    super.key,
    required this.location,
  });

  @override
  State<AgentRecentPaymentsScreen> createState() => _AgentRecentPaymentsScreenState();
}

class _AgentRecentPaymentsScreenState extends State<AgentRecentPaymentsScreen> {
  ...
  Future<void> _loadPayments() async {
    ...
    try {
      print('DEBUG: Calling fetchSuperAgentPayments with location: ${widget.location}');
      final response = await ApiService.fetchSuperAgentPayments([widget.location]);
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Last 24 hours in ${widget.location}',
                ...
                : _filteredPayments.isEmpty
                        ? EmptyState(
                            ...
                            subtitle: _searchController.text.isNotEmpty 
                                ...
                                : 'No payments have been made in the last 24 hours in ${widget.location}.',
                          )
                        : RefreshIndicator(
